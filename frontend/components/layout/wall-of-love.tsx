    ...
    const reviews = [
        {
            ...
            comment:
                'Digital Mischief Group sounds like a game changer for anyone looking to streamline their search experience! I love the idea of a hybrid AI search engine that pulls from both my personal knowledge base and the vast resources of the internet. It’s like having a personal assistant that knows exactly what I need!',
            rating: 5,
        },
        {
            id: 1,
            ...
            comment: 'I found Digital Mischief Group by chance and it is awesome! It will become my best ally from now on, it will save me a lot of time.',
            rating: 5,
        },
        {
            id: 2,
            ...
            comment:
                "Digital Mischief Group looks like it could save me a ton of time. I'm always juggling between my notes and web searches, so having everything in one place sounds awesome. Love that it's open-source too.",
            rating: 5,
        },
        {
            id: 3,
            ...
            comment: 'Digital Mischief Group has helped me solve problems I encounter daily.Highly recommend!',
            rating: 5,
        },
        {
            id: 4,
